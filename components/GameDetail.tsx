  ...
  return (
    <div className="game-detail-topbar sticky top-0 z-40 flex items-center justify-center px-4">
      ...
      {onToggleFavorite && (
        ...
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5" fill={isFavorite ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 20.6 4.8 13.5C1.2 9.9 2.6 3.7 7.7 3.7c1.8 0 3.2.9 4.3 2.7 1.1-1.8 2.5-2.7 4.3-2.7 5.1 0 6.5 6.2 2.9 9.8L12 20.6Z" />
          </svg>
        </button>
      )}
    </div>
  ...
  return (
    <div className="game-odds-panel">
      ...
      <OddsMarketCard
        title="Over/Under"
        rows={[
          { key: "over", label: "Over", value: odds?.overOdds || "—", line: total ? `o${total}` : "—" },
          { key: "under", label: "Under", value: odds?.underOdds || "—", line: total ? `u${total}` : "—" },
        ]}
        showLine
      />
    </div>
