...
export default function AppSettingsButton() {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-11 z-[999] w-72 rounded-2xl p-4 shadow-2xl space-y-4" style={{ background: "#202126", border: "1px solid var(--border)", color: "var(--text)", opacity: 1 }}>
