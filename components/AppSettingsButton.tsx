    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          />
          <div className="fixed right-3 top-14 z-[10001] w-[min(18rem,calc(100vw-1.5rem))] rounded-2xl p-4 shadow-2xl space-y-4" style={{ background: "var(--surface)", opacity: 1, border: "1px solid var(--border)", color: "var(--text)", boxShadow: "0 18px 60px rgba(0,0,0,.85)", backdropFilter: "none" }}>
