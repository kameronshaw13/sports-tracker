...
export default function TopNav({ active, onChange }: Props) {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-40 px-3 pb-[max(0.55rem,env(safe-area-inset-bottom))] pt-1.5"
        ...
        {items.map((it) => {
          ...
          return (
            <button
              ...
              className="px-2 pt-0.5 pb-1.5 text-xs font-black transition-all flex flex-col items-center gap-0.5 active:scale-[0.98] min-h-[54px] justify-start"
